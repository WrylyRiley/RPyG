...
class Person:
    ...
    def get_stats(self):
        ...
        hp_bar = int(math.ceil(25 * hp_pct))  # Bar percentage, rounded up
        mp_bar = int(math.ceil(10 * mp_pct))  # Bar percentage, rounded up
        ...
        print(
            bcolors.BOLD + self.name + hp_gap + hp_num + "  |" + bcolors.OKGREEN + hp_render + bcolors.ENDC
            + bcolors.BOLD + "|  " + mp_gap + mp_num + "  |" + bcolors.OKBLUE + mp_render + bcolors.ENDC
